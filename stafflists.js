...
stafflist.push(new Staff("Hathaway", "Mr.", "english", 0))
stafflist.push(new Staff("Kaba", "Mrs.", "english", 0))
...
stafflist.push(new Staff("Acuna", "Mrs.", "guidance", 1))
stafflist.push(new Staff("Andaloro", "Mrs.", "guidance", 1))
stafflist.push(new Staff("Belkin", "Mrs.", "guidance", 1))
stafflist.push(new Staff("Kaser", "Mr.", "guidance", 1))
stafflist.push(new Staff("Keane", "Mr.", "guidance", 1))
stafflist.push(new Staff("Natelli", "Mr.", "guidance", 1))
stafflist.push(new Staff("Sytsma", "Mrs.", "guidance", 1))
stafflist.push(new Staff("Sousa", "Mrs.", "guidance", 1))
stafflist.push(new Staff("Zurich", "Mr.", "guidance", 1))

stafflist.push(new Staff("Abramson", "Dr.", "math", 2))
stafflist.push(new Staff("Bonanomi", "Mr.", "math", 2))
stafflist.push(new Staff("Casarico", "Mrs.", "math", 1))
...
stafflist.push(new Staff("Seventko", "Mr.", "math", 2))
stafflist.push(new Staff("Walsh", "Mr.", "math", 2))
stafflist.push(new Staff("Zangara", "Mrs.", "math", 2))

stafflist.push(new Staff("Finley", "Mr.", "music", 2))
stafflist.push(new Staff("Lemma", "Mr.", "music", 0))
stafflist.push(new Staff("Spinelli", "Mr.", "music", 2))

stafflist.push(new Staff("Fuentes", "Mrs.", "gym", 1))
stafflist.push(new Staff("James", "Mrs.", "gym", 1))
stafflist.push(new Staff("Kalata", "Mr.", "gym", 1))
stafflist.push(new Staff("Marmora", "Mr.", "gym", 1))
stafflist.push(new Staff("Symons", "Mr.", "gym", 1))
stafflist.push(new Staff("Rios", "Mrs.", "gym", 1))

stafflist.push(new Staff("Crochet", "Mrs.", "theater", 1))
stafflist.push(new Staff("Kaplan", "Mr.", "theater", 0))
...
stafflist.push(new Staff("Janssen", "Mrs.", "history", 2))
